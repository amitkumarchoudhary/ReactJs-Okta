                ...
                <form onSubmit={this.handleSubmit}>
                     <div className="row">
                        ...
                        <div className="col-75">
                            <input type="text" name="id" required="required" value={this.state.id} onChange={this.handleChange}    placeholder="Your name.."/>
                        </div>
                    </div>
                    ...
                    <div className="row">
                            ...
                            <div className="col-75">
                                <input type="text" name="name" required="required" value={this.state.name} onChange={this.handleChange}  placeholder="Your last name.."/>
                            </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="row">
                                ...
                                <div className="col-75">
                                    <textarea id="address" name="address" required="required" value={this.state.address} onChange={this.handleChange}  placeholder="address......" style={{height:"50px"}}></textarea>
                                </div>
                        </div>
